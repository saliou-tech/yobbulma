...
class InsLivreur extends StatefulWidget {
  @override
  _InsLivreurState createState() => _InsLivreurState();
}

class _InsLivreurState extends State<InsLivreur> {
        ...
        body: CustomScrollView(primary: true, shrinkWrap: false, slivers: <
          ...
          SliverToBoxAdapter(
            child: Column(children: [
              ...
              Center(
                  child: Text('Inscrire un livreur',
                      style: new TextStyle(
